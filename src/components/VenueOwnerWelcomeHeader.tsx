// Welcome header component for venue owner screens with notification/message icons
...
export const VenueOwnerWelcomeHeader: React.FC<VenueOwnerWelcomeHeaderProps> = ({
  title,
  subtitle,
}) => {
  const { user } = useAuth();
